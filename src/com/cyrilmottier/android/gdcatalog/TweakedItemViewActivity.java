...
public class TweakedItemViewActivity extends GDListActivity {
    ...
    private class SectionedItemAdapter extends ItemAdapter implements SectionIndexer {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            /*
             * getPositionForSection will look for the position of 
             * the row with the same starting letter as the section
             * 
             * In this HeadedTextItem case, what it is doing is that 
             * it will check whether the section's first row is 
             * equal to the current position
             * 
             * If it is equal, set the separator class to be visible
             * Give it the value of the alphabet
             */
