...
public class CatalogActivity extends GDListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.add(createTextItem(R.string.willy_prototype, TweakedWithButtonActivity.class));

        setListAdapter(adapter);

        addActionBarItem(getActionBar()
                .newActionBarItem(NormalActionBarItem.class)
                .setDrawable(new ActionBarDrawable(this, R.drawable.ic_action_bar_info))
